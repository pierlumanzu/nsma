...
class Genetic_Algorithm(Algorithm):
    ...
    def __init__(self,
        ...
        self._survival_strategy = Genetic_Survival_Strategy(pop_size)

    @abstractmethod
    def getParents(self, p_list: np.array, f_list: np.array, constraint_violations: np.array, crowding_list: np.array):
        """
        Get the solution parents (to be implemented)
    ...
    @abstractmethod
    def getOffsprings(self, p_list: np.array, f_list: np.array, constraint_violations: np.array, crowding_list: np.array, problem: Problem):
        """
        Get the solution offsprings (to be implemented);
        :param p_list: problem solutions
        :param f_list: related points in the objectives space
