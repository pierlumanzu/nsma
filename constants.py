from Problems.MAN.MAN_Instance import MAN_1
...
In the second case, each problem class must contain an override of the function familyName() (for instance, see MOP_Instances.py).
"""
