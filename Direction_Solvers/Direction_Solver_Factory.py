from Direction_Solvers.Descent_Direction.Boundconstrained_Projected_Gradient_DDS_GurobiVersion import Boundconstrained_Projected_Gradient_DDS_GurobiVersion
from Direction_Solvers.Descent_Direction.Boundconstrained_Projected_Gradient_DDS_ScipyVersion import Boundconstrained_Projected_Gradient_DDS_ScipyVersion
...
class Direction_Descent_Factory:
    ...
    @staticmethod
    def getDirectionCalculator(direction_type: str, gurobi_version: bool, gurobi_method: int, gurobi_verbose: bool):
        """
        ...
        if gurobi_version:
            if direction_type == 'Boundconstrained_Projected_Gradient_DDS':
                return Boundconstrained_Projected_Gradient_DDS_GurobiVersion(gurobi_method, gurobi_verbose)
            else:
                raise NotImplementedError
        
        else:
            if direction_type == 'Boundconstrained_Projected_Gradient_DDS':
                return Boundconstrained_Projected_Gradient_DDS_ScipyVersion()
            else:
                raise NotImplementedError
