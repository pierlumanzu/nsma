...
class Problem:
    ...
    def evaluateFunctions(self, x: np.array):
        """
        Evaluate the objective functions given a point
        :param x: the point
    ...
    def evaluateFunctionsJacobian(self, x: np.array):
        """
        Compute the Jacobian matrix related to the objective functions given a point
        :param x: the point
    ...
    def evaluateConstraints(self, x: np.array):
        """
        Evaluate all the constraints, including the bound ones, given a point
        :param x: the point
    ...
    def evaluateConstraintsJacobian(self, x: np.array):
        """
        Compute the Jacobian matrix related to the constraints, including the bound ones, given a point
        :param x: the point
    ...
    def checkPointFeasibility(self, x: np.array):
        """
        Check the feasibility of a given point
        :param x: the point
    ...
    def generateFeasibleRandomPoint(self):
        """
        Generate a feasible random point
        :return: the point
        """
        ...
        while not self.checkPointFeasibility(x):
            x = shift + np.random.rand(self.__n) * scale

        return x

    def generateFeasiblePointsArray(self, mod: str, size: int):
        """
        Generate an array containing feasible points
        ...
        if mod.lower() == 'rand':
            ...
            for i in range(size):
                p_list[i, :] = self.generateFeasibleRandomPoint()
        else:
