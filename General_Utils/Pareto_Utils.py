...
def pointsInitialization(problem: Problem, mod: str, n_initial_points: int):
    """
    ...
    p_list = problem.generateFeasiblePointsArray(mod, n_initial_points)
...
def pointsPostprocessing(p_list: np.array, f_list: np.array, problem: Problem):
    """
...
def paretoEfficient(f_list: np.array):
    """
