...
def makeFolder(folder_path: str):
    """
...
def folderInitialization(seed: int, date: str, algorithms_names: list):
    """
...
def executionTimeFileInitialization(seed: int, date: str, algorithms_names: list):
    """
    Initialize a file for each tested algorithm in the "Execution_Times" folder (see the function folderInitialization(int, str, list)).
    :param seed: seed for the pseudo-random number generator
    :param date: date in which the execution has started
    :param algorithms_names: names of the tested algorithms
...
def writeInExecutionTimeFile(seed: int, date: str, algorithm_name: str, problem: Problem, n: int, elapsed_time: float):
    """
    Write on the file in the "Execution_Times" folder related to the algorithm at hand (see the function folderInitialization(int, str, list)) the computational time reached by the algorithm on a problem
    :param seed: seed for the pseudo-random number generator
    :param date: date in which the execution has started
...
def writeResultsInCsvFile(p_list: np.array, f_list: np.array, seed: int, date: str, algorithm_name: str, problem: Problem, export_pareto_solutions: bool = False):
    """
    Write in CSV files the Pareto front and the Pareto solutions, if requested, that an algorithm has obtained on a problem (see the function folderInitialization(int, str, list))
...
def savePlots(p_list: np.array, f_list: np.array, seed: int, date: str, algorithm_name: str, problem: Problem, export_pareto_solutions: bool, plot_dpi: int):
    """
    Save the plots of the Pareto front and of the Pareto solutions, if requested and possible (for more details, see parser_management.py), that an algorithm has obtained on a problem (see the function folderInitialization(int, str, list))
    :param p_list: Pareto solutions
    :param f_list: Pareto front
    :param seed: seed for the pseudo-random number generator
    :param date: date in which the execution has started
    ...
    graphical_plot.saveFigure(p_list, f_list, os.path.join('Execution_Outputs', date, str(seed), 'Plot'), algorithm_name, problem.__name__)
